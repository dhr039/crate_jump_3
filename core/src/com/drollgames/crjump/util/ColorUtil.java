...
public class ColorUtil {
    ...
    public static Color rgba(String colorStr) {
        ...
        return new Color(valueOf(colorStr.substring(0, 2), 16) / 255f, valueOf(colorStr.substring(2, 4), 16) / 255f, valueOf(colorStr.substring(4, 6), 16) / 255f, valueOf(colorStr.substring(6, 8), 16) / 255f);
    }
